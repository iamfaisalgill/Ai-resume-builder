...
const ImpresaTemplate = ({ deleteItem, editItem }) => {
  ...
  return (
    <div className="bg-white max-w-4xl min-h-[1122px] shadow-lg rounded-lg text-black p-4 sm:p-6 md:p-8 mx-auto font-sans text-[8px] sm:text-sm">
      <div className="c-info relative ">
        {/* <h1 className="text-[15px] sm:text-2xl md:text-3xl font-medium uppercase">
        ...
        <div className="flex items-center space-x-4 text-black mb-4">
          {/* <!-- Logo Icon --> */}
          <div className="relative w-20 h-20 flex items-center justify-center border-2 border-black">
            <span className="absolute top-1 left-2 text-3xl font-medium uppercase">
              {contactInfo.firstName.charAt(0)}
            </span>
            <span className="absolute bottom-2 right-2 text-3xl font-medium uppercase">
              {contactInfo.lastName.charAt(0)}
            </span>
            <div className="absolute w-[100%] h-[2px] bg-black rotate-[-45deg]"></div>
          </div>
          {/* <!-- Text --> */}
      ...
      {(summary || summary === "") && (
        <div className="c-info relative mt-4 sm:mt-6 md:mt-8">
          <h2 className="text-[10px] sm:text-base font-medium">
            ...
            {experience.map((exp, index) => (
              <div key={index}>
                {(exp.jobTitle ||
                  ...
                  exp.present ||
                  exp.endYear) && (
                  <div className="flex flex-col sm:flex-row sm:justify-between font-medium mt-1 sm:mt-2">
      ...
      {education && (
        <div className="c-info relative mt-4 sm:mt-6 md:mt-8">
          <h2 className="text-[10px] sm:text-base font-medium ">EDUCATION</h2>
      ...
      {projects && (
        <div className="c-info relative mt-4 sm:mt-6 md:mt-8">
          <h2 className="text-[10px] sm:text-base font-medium ">PROJECTS</h2>
      ...
      {languages && (
        <div className="c-info relative mt-4 sm:mt-6 md:mt-8">
          <h2 className="text-[10px] sm:text-base font-medium ">LANGUAGES</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-1 sm:gap-2 mt-1 sm:mt-2">
            {languages.map(
              (lang, index) =>
                lang.language && (
                  <p key={index} className="font-medium mt-1 sm:mt-2">
                    {lang.language}
...
export default ImpresaTemplate;
