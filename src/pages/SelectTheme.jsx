    ...
    function isValueEmpty(value) {
      ...
      if (typeof value === "object" && value !== null) {
        return (
          ...
          Object.values(value).every(isValueEmpty)
        );
      }
      return false;
    }
  ...
  return (
    <div className="min-w-full p-7">
      <div className="mt-8 space-y-9 p-6 max-w-[1020px] mx-auto bg-card rounded-lg">
        <div>
          <h1 className="sm:text-2xl text-lg font-medium uppercase text-center">
            Choose your resume theme
          </h1>
          <p className="text-center">
            Remember, you can always change your theme later on.
          </p>
        </div>
        {isMobile ? (
          <div className="p-2">
